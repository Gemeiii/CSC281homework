 ...
 *
 * Score: 90
 * -5 raw draw calls that are not driven by input.
 * -5 does not take input consistent with assignment specifications.
 * -10 inconsistent indentation and code formattting.
 * +10 bonus objective.
 *
