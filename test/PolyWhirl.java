...
public class PolyWhirl extends JFrame {
  ...
  class Surface extends JPanel {
    ...
    List<AnyNumberSidesShape> trises;
    // Add the lists for your shapes below.

    public Surface() {
      trises = new ArrayList<AnyNumberSidesShape>();
    ...
    public void readAndGenerateShapes() {
      ...
      while(!inputEnded){
        ...
        System.out.println("number of sides:"+posX);
        //
      ...
      */
       ...
       */
      this.trises.add(new AnyNumberSidesShape(100, 125));
      this.trises.add(new AnyNumberSidesShape(100, 225));
      this.trises.add(new AnyNumberSidesShape(200, 125));
    ...
    public void drawShapes(Graphics g) {
      ...
      for (AnyNumberSidesShape c : this.trises) {
        c.draw(g);
      }
